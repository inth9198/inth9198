...
를 설계하고 유지 보수성을 향상<br/>
2. webpack을 활용하여 번들링 작업 수행<br/>
3. webpack analyzer 를 통해 라이브러리를 분석 후 빌드 파일 용량을 53MB의 파일을 16MB용량으로
경량화<br/>
...
스 yaml작성 후 쿠버네티스를 이용하여 직접 배포)<br/>
7. vm, 스토리지, 네트워크, host OS 관련한 페이지들을 안정적으로 구현<br/>
8. eslint를 활용하여 DX최적화<br/>
9. webpack을 활용하여 번들링 작업 수행<br/>
10. Npm cve를 통해 보안 취약점 분석 및 모듈 취약부분 수정<br/>
11. 여러 데이터를 시각정보로 나타내기위해 다양한 종류의 그래프(막대, 라인, 파이, 스케터 차
트 등등) 설계<br/>
12. 새로운 페이지를 구성할 때 앱의 성능을 향상시키기 위해 Lazy loading 라우팅 사용 (First
Contentful Paint 2.8 s->0.8 s 로 겸감)<br/>
...
<br/>
1. 토폴로지 및 콜 트레이스와 같은 복잡한 ui컴포넌트 구현<br/>
2. react-hook-form 및 yup을 이용해서 생성폼 자동화<br/>
3. eslint를 활용하여 DX최적화<br/>
4. 네트워크 관련 페이지들 개발<br/>
5. TanStack Query를 활용한 비동기 데이터 페칭과 캐싱을 효율적으로 관리하여, 사용자 경
험을 개선하고 데이터 일관성을 유지 및 네트워크 요청 최적화 및 로딩 상태 관리를 강화하
여 성능을 최적화<br/>
